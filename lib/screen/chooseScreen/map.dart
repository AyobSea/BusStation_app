...
class UserChooseLocation extends StatefulWidget {
  const UserChooseLocation({
    Key? key,
  }) : super(key: key);

  @override
  State<UserChooseLocation> createState() => _UserChooseLocationState();
}

class _UserChooseLocationState extends State<UserChooseLocation> {
